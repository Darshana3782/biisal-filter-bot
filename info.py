...
#main variables
API_ID = int(environ.get('API_ID', '23155089'))
API_HASH = environ.get('API_HASH', '08c914a718fff02231d79ff61257dd89')
BOT_TOKEN = environ.get('BOT_TOKEN', '7260647026:AAE-CVI1AOTUPmXCiFvViZnB9z2nTrB9-vo')

ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1180644816').split()]
USERNAME = environ.get('USERNAME', "https://telegram.me/biisal")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002412512488'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+4RB2-U2o9yE4ZmQ9')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '').split()]
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://tharindu96:tharindu96@filterbot.h0cym.mongodb.net/")

DATABASE_NAME = environ.get('DATABASE_NAME', "TELEGRAM_BOT_INFO")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002185216442'))
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1002493948710'))
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002476987138'))
...
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002463591733'))
